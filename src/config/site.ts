...
export const siteConfig = {
  ...
  pricing: {
    audit: {
      ...
      description: "Complete audit of your existing schema with actionable fix plan",
    },
    endToEnd: {
      name: "End-to-End Design",
      price: 5000,
      priceLabel: "Starting at $5,000",
      description: "Full database architecture from requirements to production-ready schema",
    },
    partner: {
  ...
  leadMagnet: {
    ...
    description: "The 47-point checklist we use before designing any schema. Covers tenancy, auth, billing, and migrations.",
